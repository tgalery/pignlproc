 ...
 * Chris: Test script to output SF-URI counts
...
SET job.name 'Wikipedia SF-URI counts for $LANG'
...
--Now output to .TSV
--Now output to .TSV
STORE pairCounts INTO '$DIR/pair_counts_absolute.TSV' USING PigStorage();
