...
-- Project to sf, sourceURI, targetURI
...
STORE pageLinks INTO '$DIR/sf_source_target.TSV.bz2' USING PigStorage();

--Chris: output a triple - surfaceForm, sourceUri, targetUri
--pageLinks = FOREACH paragraphs GENERATE
--  TRIM(SUBSTRING(paragraph, startPos, endPos)) AS surfaceForm,
--  targetUri AS uri;
